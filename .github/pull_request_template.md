...
- [ ] JSON schemas updated (`schema/root.terse.schema.json`, `schema/adapter.terse.schema.json`, `schema/tool.terse.schema.json`, `schema/prompt.terse.schema.json`, `schema/resource.terse.schema.json`)
- [ ] Configuration schema docs updated (`docs/reference/configuration-schemas.mdx`, `docs/configuration-schemas.md`)
