...
- [ ] JSON schemas updated (`schema/root.terse.schema.json`, `schema/adapter.terse.schema.json`, `schema/tool.terse.schema.json`, `schema/prompt.terse.schema.json`, `schema/resource.terse.schema.json`, `schema/agent.terse.schema.json`)
