...
For each v1 `queries` entry, create `app/tools/<name>/config.terse`:
...
| Unknown connector type                | Use `postgres`, `mysql`, `mongodb`, `redis`, or `sqlite`. |
...
<Tree>
  <Tree.Folder name="my-api" defaultOpen>
    <Tree.File name=".hyperterse" comment="Everything in one file" />
  </Tree.Folder>
</Tree>
...
<Tree>
  <Tree.Folder name="my-api" defaultOpen>
    <Tree.File name=".hyperterse" comment="Service settings only" />
    <Tree.File name="package.json" comment="npm deps (optional)" />
    <Tree.Folder name="app" defaultOpen>
      <Tree.Folder name="adapters" defaultOpen>
        <Tree.File name="main-db.terse" />
      </Tree.Folder>
      <Tree.Folder name="tools" defaultOpen>
        <Tree.Folder name="get-user" defaultOpen>
          <Tree.File name="config.terse" />
          <Tree.File name="validate.ts" comment="optional" />
          <Tree.File name="format.ts" comment="optional" />
        </Tree.Folder>
        <Tree.Folder name="list-orders" defaultOpen>
          <Tree.File name="config.terse" />
        </Tree.Folder>
      </Tree.Folder>
    </Tree.Folder>
