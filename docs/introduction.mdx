...
With Hyperterse, you define your tools in declarative configuration files. The framework compiles, validates, bundles, and serves them as a standards-compliant [Model Context Protocol](https://modelcontextprotocol.io/) server. You own the data and the logic — the framework handles everything else.
...
<Steps>
  <Step title="Define your tools">
    Create configuration files for your database connections and tools. Each
