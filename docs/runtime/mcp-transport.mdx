...
The `content` array contains one text entry with JSON-encoded results. For DB-backed tools, this is the serialized row set. For handler tools, this is the serialized return value.
