...
<Tree>
  ...
  >
    <Tree.File
      name="hyperterse"
      comment="Runtime binary"
    />
    <Tree.File
      name="model.bin"
      comment="Serialized manifest"
    />
    <Tree.Folder
      name="build"
      defaultOpen
    >
      <Tree.File
        name="vendor.js"
        comment="Shared dependency bundle"
      />
      <Tree.Folder
        name="tools"
        defaultOpen
...
| `.agent/skills/hyperterse-docs/SKILL.md` | Agent Skills skill pointing to docs |
