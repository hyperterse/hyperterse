...
`.hyperterse` is the root service configuration. `app/tools/hello-world/` contains a script-backed tool. `.agent/skills/hyperterse-docs/` is an [Agent Skills](https://agentskills.io/home)-compliant skill that points agents to the Hyperterse docs. Add `app/adapters/` when you need database connections.
