...
If your tools use MCP session management, enable sticky sessions through your ingress controller or service mesh to route subsequent requests from the same session to the same pod.
